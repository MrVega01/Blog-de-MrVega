<form class="form-nueva-entrada" action="<?php echo ROUTE_NEW_ENTRADA; ?>" method="post">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="titulo" id="titulo"
     placeholder='No es recomendable usar emoticonos en el título.' <?php $validador -> MostrarTitulo(); ?>>
    ...
    <textarea name="texto" class="form-control" id="texto" rows="10" cols="80"
     placeholder='Escribe tu artículo...'><?php $validador -> MostrarTexto(); ?></textarea> <?php $validador-> MostrarErrorTexto(); ?>
